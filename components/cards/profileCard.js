...
<div className="h-16 w-16 ">
    <Image className="rounded-full h-14 w-14" alt="kage" src="/kage.jpg" width={100} height={100} layout="responsive" />
</div>
...
<div className="ml-4 md:ml-0 my-auto">
    ...
    <div className="font-light text-gray-600 text-xs">Frontend Engineer.</div>
</div>
    </div>
    )
}