  ...
  return (
    <div className="flex font-mono flex-col px-2  justify-center h-screen bg-gradient-to-r from-red-100 to-yellow-100">
      <div className="text-center mx-auto">
        ...
        <div className="mt-8 font-bold animate-pulse hover:text-blue-700"><a href="https://www.getrevue.co/profile/kage-ui" target={"_blank"} rel="noopener" >Join The Weekly Newsletter</a></div>
      </div>
    </div>
  );
}
